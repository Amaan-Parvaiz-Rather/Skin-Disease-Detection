"""
Skin Disease Classification - V3 Training Script (Target: 85%+)
================================================================
...
with open("results_v3.txt", "w") as f:
    f.write("SKIN DISEASE CLASSIFICATION - V3\n")
    f.write("=" * 60 + "\n\n")
...
print("Results saved to results_v3.txt")
...
plt.suptitle(f"V3 Training - Test Acc: {test_acc*100:.2f}%  TTA: {tta_acc*100:.2f}%")
plt.tight_layout()
...
plt.ylabel("True")
plt.title(f"V3 Confusion Matrix - Accuracy: {test_acc * 100:.2f}%")
plt.tight_layout()
plt.savefig("confusion_matrix_v3.png", dpi=150)
print("Confusion matrix saved to confusion_matrix_v3.png")
